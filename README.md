  ...
  <tbody>
    <tr>
      ...
      <td style="text-align:left">
        <p>A window is typically a rectangular frame within which content is presented,
          ...
          to display in full-screen mode.</p>
        <p>The SnapLogic UI can be viewed using a browser window.</p>
      </td>
      <td style="text-align:left">
    ...
    <tr>
      ...
      <td style="text-align:left">
        <p>Tabs enable users to quickly move from one set of functionalities to another.
          The SnapLogic UI comprises three tabs: Designer, Manager, and Dashboard,
          and appear at the top-left of the SnapLogic UI.</p>
        <p>Tabs that appear as part of the content inside a tab are called <b>sub-tabs</b>.</p>
        <p>There may be situations where the UI in a sub-tab has tabs too. In such
          circumstances, we consider the &apos;context of a tab&apos; .and call it
          a tab in the context of the UI of the sub-tab.</p>
        <p>For example, in the screenshot on the right, The <b>Health</b> sub-tab is
          part of the <b>Dashboard</b> tab, and there is a direct connection between
          Health and Dashboard, which is why (and how) the two are interconnected.</p>
        <p>Similarly, the Resource History tab is connected to the Health sub-tab,
          and has no direct connection with the Dashboard tab. Thus, the Resource
          History tab functions as an independent tab under the Health sub-tab.</p>
      </td>
      <td style="text-align:left">
        <img src=".gitbook/assets/2.jpeg" alt/>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td style="text-align:left">
        <p>A bounded area within a page that groups together UI elements that serve
          a specific purpose.</p>
        <p>Thus, we have the following hierarchy:</p>
        <ul>
          <li>Window
            <ul>
              <li>Page (NOT screen)
    ...
    <tr>
      ...
      <td style="text-align:left">
        <p>This is the toolbar that is visible at the top-right section of the SnapLogic
          UI. This toolbar is common to all the tabs that comprise the SnapLogic
          UI.</p>
        <p>The SnapLogic toolbar contains links (Privacy Policy), buttons (Settings,
          Notifications, and so on), and drop-down lists (The name of the Org).</p>
      </td>
      <td style="text-align:left">
    ...
    <tr>
      ...
      <td style="text-align:left">
        <p>This toolbar contains drop-down lists and buttons that enable you to access
          key Designer functionality.</p>
        <p>The Designer toolbar contains buttons (Save, Pipeline Properties, and
          so on), and drop-down lists (Snaplex name).</p>
      </td>
      <td style="text-align:left">
    ...
    <tr>
      ...
      <td style="text-align:left">
        <p>The Asset Palette contains all the assets that you need to create Pipelines.
          These are: <b>Snaps</b>, <b>Pipelines</b>, <b>Patterns</b>.</p>
        <ul>
      ...
      <td style="text-align:left">
        <img src=".gitbook/assets/7.jpeg" alt/>
      </td>
    </tr>
    <tr>
      <td style="text-align:left">Snap Catalog</td>
      <td style="text-align:left">
        <p>The Snap Catalog enables users to search for and use Snaps.</p>
        <p>The Snap Catalog contains a search field (enter search item), a drop-down
          list (Group by), and a list of Snaps, which the user can organize based
          on Snap Pack and type.</p>
      </td>
      <td style="text-align:left">
    ...
    <tr>
      ...
      <td style="text-align:left">
        <p>The Pipeline Catalog displays all the Pipelines to which the user has
          access, organizing them into their parent Projects and Project Spaces.</p>
        <p>The Pipeline Catalog contains a search field (enter search item), a drop-down
          list (Group by), and a list of Pipelines.</p>
      </td>
      <td style="text-align:left">
        <img src=".gitbook/assets/9.jpeg" alt/>
      </td>
    </tr>
    <tr>
      <td style="text-align:left">Pattern Catalog</td>
      <td style="text-align:left">
        <p>The Pattern Catalog displays all the Pattern Pipelines to which the user
          has access, organizing them into their parent Projects and Project Spaces.</p>
        <p>The Pattern Catalog contains a search field (enter search item) and a
          list of Pattern Pipelines.</p>
      </td>
      <td style="text-align:left">
    ...
    <tr>
      ...
      <td style="text-align:left">
        <p><b>Suggested Snaps</b>
        </p>
        <p>The Suggested Snaps pane appears at the bottom of the Canvas and displays
          ...
          to the Pipeline.</p>
        <p>When the canvas is blank, Iris AI displays &quot;ghost&quot; start and
          end Snaps.</p>
        <p><b>Suggested Pipelines</b>
        </p>
        <p>The Suggested Pipelines pane appears at the bottom of the Canvas and displays
    ...
    <tr>
      ...
      <td style="text-align:left">
        <p>A Snap is an object in the SnapLogic application that introspects the
          source and target and performs a single complete function, such as read,
          write, or act on data.</p>
        <p>Snaps have an input view (on the left) and an output view (on the right.)</p>
      </td>
      <td style="text-align:left">
    ...
    <tr>
      ...
      <td style="text-align:left">
        <p>A window that is dependent on the parent window, appearing as a result
          of an operation being performed on the parent window.</p>
        <p><b>What is &apos;modal&apos;?</b>
        </p>
        <p>A modal window creates a mode that disables the main window but keeps
          it visible, with the modal window as a child window in front of it.</p>
        <p>We go with &apos;dialog window&apos; because our target audience isn&apos;t
          used to &apos;modal&apos;.</p>
      </td>
      <td style="text-align:left">
    ...
    <tr>
      ...
      <td style="text-align:left">
        <p>A small clickable UI element that triggers an action. Buttons typically
          have text with boundaries and background color.</p>
        <p><b>Difference between icons and buttons</b>
        </p>
        <p>Icons can function as buttons; but buttons are not icons! Buttons are
    ...
    <tr>
      ...
      <td style="text-align:left">
        <img src=".gitbook/assets/22.png" alt/>
      </td>
    </tr>
    <tr>
      ...
      <td style="text-align:left">Icons representing a set of options, of which only one can be selected
        at a time.</td>
      <td style="text-align:left">
        <img src=".gitbook/assets/23.png" alt/>
      </td>
    </tr>
    <tr>
      ...
      <td style="text-align:left">
        <img src=".gitbook/assets/24.png" alt/>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td style="text-align:left">
        <p>UI elements displaying either as buttons or links that enable users to
          find content related to a specific topic or category.</p>
        <p>While we do not use tags in SnapLogic, we do use them to categorize our
          documentation in Confluence.</p>
      </td>
      <td style="text-align:left">
    ...
    <tr>
      ...
      <td style="text-align:left">
        <p>A graphic representing a specific action or facility. Some of these can
          be links.</p>
        <p><b>Difference between icons and buttons</b>
        </p>
        <p>Icons can function as buttons; but buttons are not icons! Buttons are
      ...
      <td style="text-align:left">
        <img src=".gitbook/assets/27.png" alt/>
        <img src=".gitbook/assets/28.jpeg" alt/>
        <img src=".gitbook/assets/29.jpeg" alt/>
      </td>
    </tr>
    <tr>
      <td style="text-align:left">Tooltip</td>
      <td style="text-align:left">
        <p>Enables a user to see information related to a specific field in the UI.
          SnapLogic uses tooltips extensively to provide embedded help to users.</p>
        <p>A tooltip also appears when you mouse over a graph item.</p>
      </td>
      <td style="text-align:left">
        <img src=".gitbook/assets/30.png" alt/>
    ...
    <tr>
      ...
      <td style="text-align:left">A context menu is a menu in a graphical user interface that appears upon
        ...
        the menu belongs.</td>
      <td style="text-align:left">
        <img src=".gitbook/assets/32.jpeg" alt/>
      </td>
    </tr>
    <tr>
      ...
      <td
      style="text-align:left">
        <img src=".gitbook/assets/33.png" alt/>
        </td>
    </tr>
    <tr>
      ...
      <td
      style="text-align:left">
        <img src=".gitbook/assets/34.jpeg" alt/>
        </td>
    </tr>
    <tr>
      <td style="text-align:left">Value</td>
      <td style="text-align:left">
        <p>Value has two acceptable meanings:</p>
        <ul>
      ...
      <td style="text-align:left">
        <img src=".gitbook/assets/35.jpeg" alt/>
        <img src=".gitbook/assets/36.jpeg" alt/>
      </td>
    </tr>
    <tr>
...
![](.gitbook/assets/39.png)Creating an MS Dynamics 365 for Sales Object
...
![](.gitbook/assets/41.png)Here's what the customer can see...
...
| Click the ![](.gitbook/assets/45.jpeg) icon to expand the pane. | Click ![](.gitbook/assets/46.jpeg) to expand the pane. |
...
![](.gitbook/assets/47.png)For a Document-Document Snap
...
![](.gitbook/assets/51.png)Click here to expand...
...
<table>
  ...
  <tbody>
    <tr>
      <td style="text-align:left">
        <p>Enter <b>/QA/projects/shared</b> in the <b>Directory</b> field.</p>
        <p>Select the <b>LZO</b> option in the <b>Compression</b> field.</p>
      </td>
      <td style="text-align:left">
        <p>Enter /QA/projects/shared in the <b>Directory</b> field.</p>
        <p>Select the LZO option in the <b>Compression</b> field.</p>
      </td>
    </tr>
  </tbody>
</table>
...
![](.gitbook/assets/53.png)What is an adverbial qualification?
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td style="text-align:left">
        <p>Once it is enabled, the Snap is automatically validated.</p>
        <p>In the meantime, the Snap Statistics display the tasks being performed
          during validation.</p>
      </td>
    </tr>
  </tbody>
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td style="text-align:left">
        <p>If used without arguments, the API method returns information about all
          the nodes in the organization.</p>
        <ul>
          <li>When moved to the Pipeline canvas, Snaps may display with an input and/or
            output.</li>
        </ul>
  ...
  <tbody>
    <tr>
      ...
      style="text-align:left">
        ...
        <td style="text-align:left">
          <p>Compound adjectives always show up before the word they modify; if their
            position changes, the hyphen may not be needed.</p>
          <p><b>Examples</b>
          </p>
          <ul>
    ...
    <tr>
      ...
      style="text-align:left">
        ...
        <td style="text-align:left">
          <p>Over time, some compound nouns may drop their hyphens, so be sure while
            using one.</p>
          <p><b>Example</b>: Floodgate, reconfigure</p>
        </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td style="text-align:left">
        <p>Many words with hyphenated prefixes have become accepted now without the
          hyphen. Check popular usage before using in docs.</p>
        <p><b>Example</b>
        </p>
        <ul>
          <li>prepopulated</li>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td
      style="text-align:left">
        <p>We have replaced the Execute during Preview check box with a drop-down
          menu. OR</p>
        <p>SnapLogic now offers a drop-down menu (containing additional options)
          instead of the Execute during Preview check box.</p>
        </td>
    </tr>
    <tr>
...
<table>
  ...
  <tbody>
    <tr>
      <td style="text-align:left">
        <p>The Designer page allows you to create and update your Pipelines.</p>
        <p>The Designer page enables you to create and update your Pipelines.</p>
      </td>
      <td style="text-align:left">
        <p>Use the Designer page to create and update your Pipelines. OR</p>
        <p>Create and update your Pipelines using the Designer page.</p>
      </td>
    </tr>
  </tbody>
</table>
...
<table>
  ...
  <tbody>
    <tr>
      <td style="text-align:left">
        <p>Enter the name of the Snap.</p>
        <p>Enter name of the Snap.</p>
      </td>
...
![](.gitbook/assets/54.png)Why page and screen labels are especially important
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td style="text-align:left">
        <p>Unable to fetch private key aliases</p>
        <p>Unable to obtain access token %s</p>
      </td>
      <td style="text-align:left">
        <p>You may encounter error strings like the following: Unable to fetch private
          ...
          sentence into two strings.</p>
        <p>&quot;Unable to&quot; is often replaced with &quot;Failed to&quot;. Change
          all instances of these to &quot;Unable to&quot;.</p>
        <p>In some instances, the word &apos;error&apos; may be apt. For example:
          ...
          a more objective description of the situation.</p>
        <p>You may encounter error strings such as &quot;Dn error&quot;. This doesn&apos;t
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td style="text-align:left">Unable to ...</td>
      <td style="text-align:left">
        <p>Change &quot;Dataset metadata error&quot; to &quot;Unable to read (or
          write, as applicable) dataset metadata&quot;</p>
        <p>Avoid generic error messages, such as &quot;Snap configuration error&quot;.
          ...
          string to &quot;Unable to read dataset ID %s&quot;</p>
      </td>
    </tr>
  </tbody>
</table>
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td style="text-align:left">
        <p>Avoid adverbs.</p>
        <p>If a noun phrase can work without changing the meaning of the sentence,
          delete the additional verb. See example 2 on the left.</p>
      </td>
    </tr>
    <tr>
      <td style="text-align:left">Noun Phrase</td>
      ...
      <td style="text-align:left">
        <p>Error while suggesting private key aliases: %s</p>
        <p>Error fetching fields for the %s schema: %s</p>
      </td>
    ...
    <tr>
      ...
      <td style="text-align:left">
        <p>There was no private key &#x2192; No private key found</p>
        <p>Key length must be divisible by four</p>
      </td>
      <td style="text-align:left">
        <ul>
        ...
        <p>Avoid standard Noun-Verb-Object constructions as far as possible. Keep
          it pithy and precise.</p>
      </td>
    </tr>
  </tbody>
</table>
